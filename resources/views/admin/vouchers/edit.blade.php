...
<div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
    <div>
        <h1 class="text-3xl font-bold tracking-tight text-zinc-900">Edit Voucher</h1>
        <p class="text-zinc-500 text-sm mt-1">Ubah detail kode voucher diskon yang sudah terdaftar.</p>
    </div>
