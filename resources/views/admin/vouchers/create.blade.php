...
<div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-10">
    <div>
        ...
        <h1 class="text-3xl md:text-4xl font-bold text-stone-900 tracking-tight mt-1 serif-font" style="font-family: 'Playfair Display', serif;">Tambah Voucher Baru</h1>
        <p class="text-stone-500 text-sm mt-0.5">Buat kode voucher potongan harga untuk promosi atau event tertentu.</p>
    </div>
...
<div class="bg-white rounded-[2.5rem] border border-stone-200/60 shadow-sm p-8 md:p-14 max-w-3xl relative overflow-hidden">
    ...
    <form action="{{ route('admin.vouchers.store') }}" method="POST" class="space-y-8 relative z-10">
        @csrf
